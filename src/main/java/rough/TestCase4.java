...
public class TestCase4 {
	...
	public void setUp() throws Exception {
	  ...
	  public void testTestCase4() throws Exception {
	    ...
	    driver.findElement(By.xpath("//a[@title='IPhone']/parent::h2/following::a[3]")).click();
	    ...
	    Thread.sleep(1000);
	    driver.findElement(By.xpath("//a[@title='Sony Xperia']/parent::h2/following::a[3]")).click();   
	    ...
	    String handlepopup	= driver.getWindowHandle();
	    System.out.println(handlepopup);
    	driver.switchTo().window(handlepopup);
